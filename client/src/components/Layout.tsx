      ...
      <main style={{ marginTop: 65 }}>
        {currentPlayTrack && isAuthenticated && (
          ...
          >
            ...
            >
              <CloseIcon sx={iconStyles} onClick={() => dispatch(clearCurrentPlayTrack())} />
              {visibleVideo ? (
                <VisibilityOffIcon sx={iconStyles} onClick={() => dispatch(toggleVisibleVideo())} />
              ) : (
                <YouTubeIcon sx={iconStyles} onClick={() => dispatch(toggleVisibleVideo())} />
              )}
            </Box>
          </Box>
        )}
